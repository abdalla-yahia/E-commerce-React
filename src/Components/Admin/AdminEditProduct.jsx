...
import UpdateAspecificProductHook from '../../Hook/Products/Update-Aspecific-product';
...
function AdminEditProduct() {
    ...
    const  [setID,setBrand,images, setImages,name,setName,
        ...
        categories,brands,state,onSelect,onRemove,updateHandellerSubmit,ID,brand,
    ] = UpdateAspecificProductHook()
    ...
    const TextCountHandeller=(e)=>{
        ...
        <div className='d-flex flex-column justify-content-start align-items-start gap-3'>
            ...
            <button onClick={()=> updateHandellerSubmit()} className='btn btn-dark w-25' style={{float:'left'}} type='submit'>تعديل المنتج</button>
            </div>
            </form >
            <TostifyLiprary />
        </div>
